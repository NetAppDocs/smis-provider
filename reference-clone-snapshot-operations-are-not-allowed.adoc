...
[.lead]
You might encounter an error indicating that clone or Snapshot copy operations are not allowed while a LUN clone split operation is in progress. Learn why this error occurs and when you can retry the operation.
