...
[.lead]
The total managed space reported for a storage pool (volume) by NetApp SMI-S Provider can differ from the size shown by other storage management tools, such as FilerView. Learn why this discrepancy occurs and confirm that no corrective action is required.
