...
[.lead]
Passwords that contain special characters can cause the `smis` command to fail in a Windows environment. Learn which characters require special handling and how to enter such passwords successfully.
