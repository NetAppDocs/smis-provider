...
[.lead]
Passwords that contain special characters can cause the `smis` command to fail in a Windows environment. Enclose such passwords in double quotes to enter them successfully.
