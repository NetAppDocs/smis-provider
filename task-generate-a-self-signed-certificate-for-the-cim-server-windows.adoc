...
+
This only sets the variable location for the duration of the current Command Prompt session. To set the variable location permanently, you can use one of the following options:
+ 
* Navigate to  *Properties > Environmental Variables* and set the variable under *System*.
