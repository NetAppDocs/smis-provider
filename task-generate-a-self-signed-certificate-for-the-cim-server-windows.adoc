...
+
This only sets the environment variable location for the duration of the current Command Prompt session. To permanently set the environment variable, you can use one of the following options:
+ 
