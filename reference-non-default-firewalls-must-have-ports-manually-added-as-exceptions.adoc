...
[.lead]
If you use a firewall other than the default Windows firewall, NetApp SMI-S Provider might be unable to communicate with clients or send indications unless the required ports are added as exceptions. Learn which ports to add to your firewall configuration.
