...
summary: "Thesmis disks command displays disk information for storage systems. smis disks only functions when used with ONTAP 7-Mode controllers."
---
= smis disks
:icons: font
:imagesdir: ./media/
...
[.lead]
The``smis disks`` command displays disk information for storage systems. `smis disks` only functions when used with ONTAP 7-Mode controllers.
