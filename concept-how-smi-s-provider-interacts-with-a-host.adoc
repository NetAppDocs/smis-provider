...
image::../media/smi_s_agent_and_host_interaction.gif["A diagram that shows a host sending queries to SMI-S Provider CIMOM, repository, provider DLLs, and storage system"]
