...
* *Cause*
+
This issue occurs when quota reinitialization takes a long time in ONTAP due to heavy I/O, new or existing SMB 3.0 share size can drop to 0 in SCVMM. Because of this, new VMs cannot be provisioned on the new or existing SMB 3.0 shares.
