...
. Navigate to the directory that contains the NetApp SMI-S Provider software package (`smisprovider-_version_number.msi_`), and then double-click the package name.
