...
[.lead]
A `Connection refused` message indicates that the CIM server used by NetApp SMI-S Provider has not been started. Verify the CIM server status and start it if needed.
