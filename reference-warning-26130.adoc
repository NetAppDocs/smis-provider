...
[.lead]
Warning 26130 occurs when storage capacity is allocated to a host group in which none of the hosts have access to the storage array, preventing you from placing virtual machines on the storage system. Grant the required access to each host to resolve this warning.
