...
System Center Virtual Machine Manager (SCVMM) Update Rollup (UR) 2.1 is required to manage NetApp File Server with NetApp SMI-S Provider 5.2.6 P4 and later.
