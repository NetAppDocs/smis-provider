...
System Center Virtual Machine Manager (SCVMM) Update Rollup (UR) 2.1 is required to manage NetApp File Server with NetApp SMI-S Provider 5.2.7 and later.

Without this UR, SCVMM (version 2016, 2019, 2022 or 2025) displays the value of the `Total Capacity` and `Available Capacity` options as `*0 GB*` for the existing file shares in NetApp File Server.
...
// 2025-12-8, jira OTHERDOC 173 naadia
