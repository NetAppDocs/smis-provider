...
summary: "You can install NetApp SMI-S Provider software so that you can manage storage systems that run ONTAP. By default, the NetApp SMI-S Provider software is installed in the C:\\Program Files (x86)\\NetApp\\smis\\pegasus directory."
---
...
[.lead]
You can install NetApp SMI-S Provider software so that you can manage storage systems that run ONTAP. However, you cannot revert or downgrade to an earlier version. By default, the NetApp SMI-S Provider software is installed in the `C:\Program Files (x86)\NetApp\smis\pegasus` directory.
