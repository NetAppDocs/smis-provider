...
[.lead]
In rare instances, System Center Virtual Machine Manager (SCVMM) cannot locate or communicate with NetApp SMI-S Provider after a security infrastructure update. Learn why this issue occurs and how to resolve it by reinstalling the provider and rescanning.
