...
[.lead]
NetApp SMI-S Provider can occasionally crash in a Windows environment. Collect the dump, log, and trace files generated at the time of the crash and send them to technical support for further analysis.
