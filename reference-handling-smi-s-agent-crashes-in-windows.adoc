...
[.lead]
NetApp SMI-S Provider can occasionally crash in a Windows environment. Learn what information to collect and send to technical support so the cause of the crash can be diagnosed.
